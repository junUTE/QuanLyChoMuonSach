    ...
    public partial class frmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (tk != null)
            {
                ...
                // Ghép connection string động từ username/password
                string conn = $"Data Source=.;Initial Catalog=QLThuVien;User ID={username};Password={password};TrustServerCertificate=True";
